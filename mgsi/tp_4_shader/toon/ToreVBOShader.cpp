...
//pour l'affichage
    ...
    plane_model = glm::translate(plane_model, glm::vec3(0,0,cameraDistance));
    ...
    plane_model = glm::scale(plane_model, glm::vec3(2, 2, 2));
    glm::mat4 plane_MVP = Projection * View * plane_model;
    glUniformMatrix4fv(MatrixIDMVP, 1, GL_FALSE, &plane_MVP[0][0]);
